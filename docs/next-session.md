...
| 🟠 | Wrench "Road" icon on ETA page ambiguous | `/en-route` ETA card | What category does Wrench-Road indicate? Roadside? Hazard? Iconography review. Needs a new SVG asset — the wrench reads as "roadside assistance" rather than "road condition." |
